...
def generate_mask(input_image, net, palette, device = 'cpu'):
    ...
    alpha_out_dir = os.path.join(opt.output,'alpha', args.user_id)
    cloth_seg_out_dir = os.path.join(opt.output,'cloth_seg', args.user_id)
    ...
    for cls in classes_to_save:
        ...
        alpha_mask_img.save(os.path.join(alpha_out_dir, f'{body_parts[cls]}.png'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', type=str, default='closes-segmentation/model/cloth_segm.pth', help='Path to the checkpoint file')
